...
# CUDA_VISIBLE_DEVICES=5 accelerate launch --gpu_ids 5 baselines/color/online_evaluation_color_bart.py \
#      --dataset durecdial \
...
CUDA_VISIBLE_DEVICES=5 accelerate launch --gpu_ids 5 baselines/color/online_evaluation_color_bart.py \
    ...
    --test_data_path data/INSPIRED/data/dialog_data/test.tsv \
     ...
     --plm_know_generation_model facebook/bart-base \
     --max_sequence_length 512 \
     --policy_model_path ./color_inspired_2/ \
