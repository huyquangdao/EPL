...
class TCPBartOnlineEval(BaseOnlineEval):
    ...
    def init_state(self, target_item, system_initial_resp="Hello ! How do I help you ?"):
        ...
        state['knowledge'] = ["None", "None", "None"]
    ...
    def pipeline(self, state):
        ...
        action = predict_action_tcp(args=self.args,
        ...
        # re-asigned the knowledge to blank
        # just for convenience
        ...
        state['knowledge'] = [state['task_background']['target_topic'], "", ""]
